...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraEditar 
      ...
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":1D44
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":1D6C
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":29BE
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":29E6
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":3638
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":3660
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":42B2
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":42DA
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":4F2C
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":4F54
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":5BA6
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":5BCE
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":6820
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":6848
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":6ECA
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":6EF2
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBEdit 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":7394
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":73BC
         cback           =   -2147483633
      End
   End
   Begin VB.Frame FraVer 
      ...
      Begin WinterMapEditor.lvButtons_H LvBOpcion 
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":7696
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":76BE
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBOpcion 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":8310
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":8338
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBOpcion 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":8F8A
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":8FB2
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBOpcion 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":9C04
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":9C2C
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBOpcion 
         Height          =   375
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":A87E
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":A8A6
         cback           =   -2147483633
      End
      Begin WinterMapEditor.lvButtons_H LvBOpcion 
         Height          =   375
      ...
      Begin WinterMapEditor.lvButtons_H LvBOpcion 
         ...
         backstyle       =   2
         cgradient       =   0
         font            =   "frmMain.frx":B018
         mode            =   1
         value           =   0   'False
         image           =   "frmMain.frx":B040
         cback           =   -2147483633
      End
   End
...
Private Sub Form_Load()
    ...
    Else
        ClientSetup.MapTam = GetVar(configFile, "MOSTRAR", "MapTam")
        
    End If
    
    Call frmMapInfo.LvBOptX_Click(CInt(ClientSetup.MapTam))
