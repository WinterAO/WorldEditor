   ...
   Begin VB.Frame FraInformacion 
      ...
      Begin VB.Frame FraLuzBase 
         ...
         Begin WinterMapEditor.lvButtons_H LvBActualizarLuces 
            ...
            capalign        =   2
            backstyle       =   2
            font            =   "frmMapInfo.frx":632B
            cgradient       =   0
            mode            =   0
            value           =   0   'False
            image           =   "frmMapInfo.frx":6353
            cback           =   -2147483633
         End
      ...
      Begin VB.ComboBox txtMapTerreno 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmMapInfo.frx":1CC95
         Left            =   1680
         List            =   "frmMapInfo.frx":1CCA2
         TabIndex        =   11
         Text            =   "txtMapTerreno"
         Top             =   1800
         Width           =   2655
      ...
      Begin VB.ComboBox txtMapRestringir 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmMapInfo.frx":1CCBF
         Left            =   1680
         List            =   "frmMapInfo.frx":1CCD5
         TabIndex        =   9
